...
export function AjustarPonto() {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Ajustar ponto</Text>
      ...
      <TextInput value={observacao} onChangeText={setObservacao} placeholder="Observação" style={styles.input} multiline />
